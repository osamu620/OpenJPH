...
ojph_opt_enc_mps = [264, 222, 216, 192, 187, 168]
ojph_opt_enc_ms  = [31.4, 37.3, 38.4, 43.2, 44.4, 49.3]
...
ojph_opt_dec_mps = [238, 208, 187, 173, 174, 150]
ojph_opt_dec_ms  = [34.9, 39.9, 44.3, 48.0, 47.7, 55.2]

# Lossless data points
ll_bpp = 9.11
ojph_ll_enc_orig_mps = 62
ojph_ll_enc_opt_mps = 111
kdu_ll_enc_mps = 301
ojph_ll_enc_orig_ms = 133.6
ojph_ll_enc_opt_ms = 74.9
kdu_ll_enc_ms = 27.5
ojph_ll_dec_orig_mps = 109
ojph_ll_dec_opt_mps = 108
kdu_ll_dec_mps = 163
ojph_ll_dec_orig_ms = 76.0
ojph_ll_dec_opt_ms = 77.0
kdu_ll_dec_ms = 51.0
...
ax.annotate('+79%', xy=(ll_bpp, ojph_ll_enc_opt_mps),
...
ax.annotate('+79%', xy=(ll_bpp, ojph_ll_enc_opt_ms),
